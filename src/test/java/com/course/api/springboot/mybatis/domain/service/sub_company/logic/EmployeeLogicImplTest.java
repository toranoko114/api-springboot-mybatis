package com.course.api.springboot.mybatis.domain.service.sub_company.logic;
...
import com.course.api.springboot.mybatis.domain.dto.HistoryDto;
import com.course.api.springboot.mybatis.domain.dto.PersonalDto;
...
import com.course.api.springboot.mybatis.infrastructure.mapper.sub_company.SubHistoryMapper;
import com.course.api.springboot.mybatis.infrastructure.mapper.sub_company.SubPersonalMapper;
...
class EmployeeLogicImplTest {
  ...
  @SpyBean
  private SubHistoryMapper historyMapper;
  @SpyBean
  private SubPersonalMapper personalMapper;

  private static final String PROVIDER_PATH =
      "com.course.api.springboot.mybatis.domain.service.sub_company.logic.EmployeeLogicImplTest#provider_entity";
